...
nooflayers = 1 #noofhiddenlayers defined
noofneurons = 2 #noofneurons in each hidden layer
...
for counter in listofneurons:
    current = ({'id':counter+1, 'bias': outputbias[counter], 'weights':map(str, outputweights[:,counter]), 'label':encodermapping[counter]})
